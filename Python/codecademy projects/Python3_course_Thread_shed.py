...
for i in daily_transactions_split:
    transaction_clean.append([e.replace("\n", " ").strip(" ") for e in i])
...
for i in thread_sold:
    if "&" in i:
        i_split = i.split("&")
        thread_sold_split.extend(i_split)
...
#for i in colors:
    #color_count("white")
   # print(f"Thread Shed sold {} of {} thread today")

for color in colors:
    print(f"Thread Shed sold {color_count(color)} threads of {color} thread today.")

#print(f"Thread Shed sold {Counter} threads of {color} thread today.")